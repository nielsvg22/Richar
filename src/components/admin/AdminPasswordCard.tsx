  ...
  return (
    <div className="rounded-[2rem] bg-white p-6 shadow-sm sm:p-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-heading text-lg font-bold">Admin-wachtwoord</h2>
          <p className="text-sm text-ink-soft">
            Dit wachtwoord geldt voor de hele team-omgeving.
          </p>
        </div>
      </div>
      ...
      {!open ? (
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          <div>
            <label htmlFor="admin-current-password" className="text-xs font-semibold text-ink-soft">
              Huidig wachtwoord
            </label>
            <input
          ...
          <div>
            <label htmlFor="admin-new-password" className="text-xs font-semibold text-ink-soft">
              Nieuw wachtwoord
            </label>
            <input
